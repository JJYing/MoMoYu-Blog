...
上周更新的 **V1.1 版**摸摸鱼终于加入了大家期望已久的网页时长记录功能（虽然还不完美），之前就提过这个功能其实还挺难做的，技术方案有不少可选项但都各有利弊，比如说很多人的第一反应（包括我自己）靠浏览器插件做。所以这篇就聊一聊摸摸鱼最后采用的方案细节，是一个挺「克制」的方法——不进驻浏览器、不读取网页本身内容，只在 macOS 系统这一层做判断，简单一句话概括就是：
